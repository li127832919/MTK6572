...
ifneq ($(CUSTOM_KPD_NAME),)
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/mtk-kpd.$(CUSTOM_KPD_NAME).kl:system/usr/keylayout/mtk-kpd.kl
endif
...
ifeq ($(MTK_RESERVE_PARTITIONS),yes)
PRODUCT_COPY_FILES += $(LOCAL_PATH)/init.reserve.rc:root/init.reserve.rc
endif
