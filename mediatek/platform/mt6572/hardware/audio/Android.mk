...
ifeq ($(strip $(MTK_HFP1_6_SUPPORT)),yes)
  LOCAL_C_INCLUDES+= \
    $(MTK_PATH_SOURCE)/external/cvsd_plc_codec_v2 \
...
ifeq ($(strip $(MTK_HFP1_6_SUPPORT)),yes)
  ...
  LOCAL_CFLAGS += -DMTK_HFP1_6_SUPPORT
else
  LOCAL_SHARED_LIBRARIES += \
    libcvsd_mtk
endif
...
# DMNR 3.0--ASR
ifeq ($(strip $(MTK_ASR_SUPPORT)),yes)
  LOCAL_CFLAGS += -DMTK_ASR_SUPPORT
endif
# DMNR 3.0--ASR

# DMNR 3.0
ifeq ($(strip $(MTK_BESRECORD_2_0_SUPPORT)),yes)
  LOCAL_CFLAGS += -DMTK_BESRECORD_2_0_SUPPORT
endif
# DMNR 3.0
