...
//				ALOGD("btsco_process_RX_CVSD(+) insize=%d,outsize=%d,packetvalid=%d ",insize,outsize,packetvalid);
				...
				bytes -= insize;
				ALOGV("btsco_process_RX_CVSD(-) consumed=%d,outsize=%d, bytes=%d, packetvalid=%d",insize,outsize,bytes, packetvalid);
				//WritePcmDumpData();
...
//      ALOGD("btsco_process_RX_MSBC(+) insize=%d,outsize=%d,packetvalid=%d ",insize,outsize,packetvalid);
      ...
      offset += SCO_RX_PLC_SIZE;
      bytes -= insize;
      ALOGV("btsco_process_RX_MSBC(-) consumed=%d,outsize=%d, bytes=%d, packetvalid=%d", insize, outsize, bytes, packetvalid);
