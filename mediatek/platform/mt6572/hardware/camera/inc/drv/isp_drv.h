...
public:
    ...
    virtual MBOOL   forcetwocore(void);
    virtual MBOOL   checkGreySensor(void);
    virtual MBOOL   captureGreySensor(MBOOL capture);
    virtual MBOOL   convertGreyData(unsigned int vAddr, unsigned int size, MBOOL capture);
