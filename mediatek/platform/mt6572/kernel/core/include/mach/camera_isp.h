...
typedef enum
{
    ISP_CMD_RESET,          //Reset
    ISP_CMD_RESET_BUF,
    ISP_CMD_FORCE_TWO_CORE,  //force two core on
...
//    ISP_CMD_SET_USER_PID,   //for signal
    ...
    ISP_CMD_CHECK_GREY,     //check is grey sensor
}ISP_CMD_ENUM;

#define ISP_IOC_RESET           _IO  (ISP_MAGIC, ISP_CMD_RESET)
#define ISP_IOC_RESET_BUF       _IO  (ISP_MAGIC, ISP_CMD_RESET_BUF)
#define ISP_IOC_FORCE_TWO_CORE  _IO  (ISP_MAGIC, ISP_CMD_FORCE_TWO_CORE)
...
#define ISP_IOC_CHECK_GREY      _IOR (ISP_MAGIC, ISP_CMD_CHECK_GREY,      unsigned int)
/*******************************************************************************
*
********************************************************************************/
