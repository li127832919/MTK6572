...
# Generated at 2013-07-05 11:16:32

DUAL_TALK_RX_GAIN_TABLE_CO_BAND_SUPPORT = FALSE     # Description:
                                                    # Option Values:
                                                    # TRUE: Support RX co-band gain table
                                                    # FALSE: Not support RX co-band gain table


TEE_SECURE_SHAREDMEM_SUPPORT = FALSE     # Description:
                                         # Option Values:
                                         # TRUE: TEE will select security RPC shared memory path
                                         # FALSE: TEE will select normal RPC shared memory path


RPMB_SECURE_SHAREDMEM_SUPPORT = FALSE     # Description:
                                          # Option Values:
                                          # TRUE: RPMB will select security RPC shared memory path
                                          # FALSE: RPMB will select normal RPC shared memory path


CDMA_USE_MTK_BB_PMU = FALSE     # TRUE: CDMA modem needs BB PMU
                                # FALSE: CDMA modem doesn't need BB PMU


EVDO_CT_SUPPORT = FALSE     # Description:
                            # Option Values:
                            # TRUE: Enable EVDO China Telecom features
                            # FALSE: Disable EVDO China Telecom features


L1_COCLK_REQUIREMENT_CHECK_SUPPORT = FALSE     # Description:
                                               # Depend on this option to define if the platform supports L1 queries CoClock requirement.
                                               # Option Values:
                                               # TRUE: L1 queries CoClock requirement is supported.
                                               # FALSE: L1 queries CoClock requirement is unsupported.
                                               # Switch-ability:
                                               # Non-switchable 
...
ACC_NC_AFC_DB_UPDATE_SUPPORT = FALSE     # TRUE:Enable accelerating neighboring cell AFC database updating
...
BOARD_VER = LIGHTNING72_WET_L_JB3_BB
  # Description:
...
PROJECT_MAKEFILE_EXT = LIGHTNING72_WET_L_JB3_HSPA_EXT
