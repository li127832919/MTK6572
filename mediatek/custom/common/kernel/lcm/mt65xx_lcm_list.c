...
extern LCM_DRIVER ili9806c_wvga_dsi_vdo_drv;
extern LCM_DRIVER ili9488_hvga_dsi_drv;
extern LCM_DRIVER st7789s_lcm_drv;
extern LCM_DRIVER bl24086_p1213_lcm_drv;
...
{ 
  ...
  &nt35510_fwvga_lcm_drv,
	...
	&ili9806c_wvga_dsi_vdo_drv,
#endif

#if defined(ILI9488_HVGA_DSI)
    &ili9488_hvga_dsi_drv,
#endif
...
#if defined(BL24086_P1213)
    &bl24086_p1213_lcm_drv,
#endif
};
