...
*********************************************************/
	...
	//use 0X02A2 instead of 0x027A could take effect,but will bring side effect:"capture couldn't get enough data";
	//so,suggest to define mirrorFlip in init setting;
	//"0x030c,0x033c,0x036c,0x039c,0x03cc"
