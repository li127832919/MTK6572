...
UINT32 MT9M114InitialSetting()
{
    ...
    //MT9M114_write_cmos_sensor(0x0016, 0x4022);  
	...
	MT9M114_write_cmos_sensor(0x3640, 0x0370 ); //	P_G1_P0Q0
	MT9M114_write_cmos_sensor(0x3642, 0xED49 ); //	P_G1_P0Q1
	MT9M114_write_cmos_sensor(0x3644, 0x6DD0 ); //	P_G1_P0Q2
	MT9M114_write_cmos_sensor(0x3646, 0x920B ); //	P_G1_P0Q3
	MT9M114_write_cmos_sensor(0x3648, 0x822F ); //	P_G1_P0Q4
	MT9M114_write_cmos_sensor(0x364A, 0x00D0 ); //	P_R_P0Q0
	MT9M114_write_cmos_sensor(0x364C, 0x2C0B ); //	P_R_P0Q1
	MT9M114_write_cmos_sensor(0x364E, 0x0031 ); //	P_R_P0Q2
	MT9M114_write_cmos_sensor(0x3650, 0x844D ); //	P_R_P0Q3
	MT9M114_write_cmos_sensor(0x3652, 0xA78F ); //	P_R_P0Q4
	MT9M114_write_cmos_sensor(0x3654, 0x0130 ); //	P_B_P0Q0
	MT9M114_write_cmos_sensor(0x3656, 0x274C ); //	P_B_P0Q1
	MT9M114_write_cmos_sensor(0x3658, 0x3ED0 ); //	P_B_P0Q2
	MT9M114_write_cmos_sensor(0x365A, 0xD0AD ); //	P_B_P0Q3
	MT9M114_write_cmos_sensor(0x365C, 0x9B8F ); //	P_B_P0Q4
	MT9M114_write_cmos_sensor(0x365E, 0x00D0 ); //	P_G2_P0Q0
	MT9M114_write_cmos_sensor(0x3660, 0xDBA9 ); //	P_G2_P0Q1
	MT9M114_write_cmos_sensor(0x3662, 0x7210 ); //	P_G2_P0Q2
	MT9M114_write_cmos_sensor(0x3664, 0xA48B ); //	P_G2_P0Q3
	MT9M114_write_cmos_sensor(0x3666, 0x9B6F ); //	P_G2_P0Q4
	MT9M114_write_cmos_sensor(0x3680, 0x1789 ); //	P_G1_P1Q0
	MT9M114_write_cmos_sensor(0x3682, 0x276D ); //	P_G1_P1Q1
	MT9M114_write_cmos_sensor(0x3684, 0x644F ); //	P_G1_P1Q2
	MT9M114_write_cmos_sensor(0x3686, 0xD4CD ); //	P_G1_P1Q3
	MT9M114_write_cmos_sensor(0x3688, 0xE7B0 ); //	P_G1_P1Q4
	MT9M114_write_cmos_sensor(0x368A, 0x996A ); //	P_R_P1Q0
	MT9M114_write_cmos_sensor(0x368C, 0x2D2D ); //	P_R_P1Q1
	MT9M114_write_cmos_sensor(0x368E, 0x60CF ); //	P_R_P1Q2
	MT9M114_write_cmos_sensor(0x3690, 0x84ED ); //	P_R_P1Q3
	MT9M114_write_cmos_sensor(0x3692, 0xC270 ); //	P_R_P1Q4
	MT9M114_write_cmos_sensor(0x3694, 0x6F6B ); //	P_B_P1Q0
	MT9M114_write_cmos_sensor(0x3696, 0x568B ); //	P_B_P1Q1
	MT9M114_write_cmos_sensor(0x3698, 0x2F4E ); //	P_B_P1Q2
	MT9M114_write_cmos_sensor(0x369A, 0xC58E ); //	P_B_P1Q3
	MT9M114_write_cmos_sensor(0x369C, 0x9890 ); //	P_B_P1Q4
	MT9M114_write_cmos_sensor(0x369E, 0x116B ); //	P_G2_P1Q0
	MT9M114_write_cmos_sensor(0x36A0, 0x0A0C ); //	P_G2_P1Q1
	MT9M114_write_cmos_sensor(0x36A2, 0x392E ); //	P_G2_P1Q2
	MT9M114_write_cmos_sensor(0x36A4, 0xAE6E ); //	P_G2_P1Q3
	MT9M114_write_cmos_sensor(0x36A6, 0xD4F0 ); //	P_G2_P1Q4
	MT9M114_write_cmos_sensor(0x36C0, 0x0011 ); //	P_G1_P2Q0
	MT9M114_write_cmos_sensor(0x36C2, 0xFF0E ); //	P_G1_P2Q1
	MT9M114_write_cmos_sensor(0x36C4, 0x1911 ); //	P_G1_P2Q2
	MT9M114_write_cmos_sensor(0x36C6, 0x1590 ); //	P_G1_P2Q3
	MT9M114_write_cmos_sensor(0x36C8, 0xBBB3 ); //	P_G1_P2Q4
	MT9M114_write_cmos_sensor(0x36CA, 0x06B1 ); //	P_R_P2Q0
	MT9M114_write_cmos_sensor(0x36CC, 0xD3AE ); //	P_R_P2Q1
	MT9M114_write_cmos_sensor(0x36CE, 0x1B71 ); //	P_R_P2Q2
	MT9M114_write_cmos_sensor(0x36D0, 0x686C ); //	P_R_P2Q3
	MT9M114_write_cmos_sensor(0x36D2, 0xD033 ); //	P_R_P2Q4
	MT9M114_write_cmos_sensor(0x36D4, 0x4F10 ); //	P_B_P2Q0
	MT9M114_write_cmos_sensor(0x36D6, 0xA18F ); //	P_B_P2Q1
	MT9M114_write_cmos_sensor(0x36D8, 0x58D0 ); //	P_B_P2Q2
	MT9M114_write_cmos_sensor(0x36DA, 0x494F ); //	P_B_P2Q3
	MT9M114_write_cmos_sensor(0x36DC, 0x8333 ); //	P_B_P2Q4
	MT9M114_write_cmos_sensor(0x36DE, 0x0391 ); //	P_G2_P2Q0
	MT9M114_write_cmos_sensor(0x36E0, 0x8E8F ); //	P_G2_P2Q1
	MT9M114_write_cmos_sensor(0x36E2, 0x6BF0 ); //	P_G2_P2Q2
	MT9M114_write_cmos_sensor(0x36E4, 0x1EB0 ); //	P_G2_P2Q3
	MT9M114_write_cmos_sensor(0x36E6, 0xA0F3 ); //	P_G2_P2Q4
	MT9M114_write_cmos_sensor(0x3700, 0x10EF ); //	P_G1_P3Q0
	MT9M114_write_cmos_sensor(0x3702, 0x8E0F ); //	P_G1_P3Q1
	MT9M114_write_cmos_sensor(0x3704, 0xD6B1 ); //	P_G1_P3Q2
	MT9M114_write_cmos_sensor(0x3706, 0x7ECF ); //	P_G1_P3Q3
	MT9M114_write_cmos_sensor(0x3708, 0x3E13 ); //	P_G1_P3Q4
	MT9M114_write_cmos_sensor(0x370A, 0x08CF ); //	P_R_P3Q0
	MT9M114_write_cmos_sensor(0x370C, 0xA6CF ); //	P_R_P3Q1
	MT9M114_write_cmos_sensor(0x370E, 0xB291 ); //	P_R_P3Q2
	MT9M114_write_cmos_sensor(0x3710, 0x52AF ); //	P_R_P3Q3
	MT9M114_write_cmos_sensor(0x3712, 0x1513 ); //	P_R_P3Q4
	MT9M114_write_cmos_sensor(0x3714, 0x0FAF ); //	P_B_P3Q0
	MT9M114_write_cmos_sensor(0x3716, 0xA82E ); //	P_B_P3Q1
	MT9M114_write_cmos_sensor(0x3718, 0x8DF1 ); //	P_B_P3Q2
	MT9M114_write_cmos_sensor(0x371A, 0x0D10 ); //	P_B_P3Q3
	MT9M114_write_cmos_sensor(0x371C, 0x06D3 ); //	P_B_P3Q4
	MT9M114_write_cmos_sensor(0x371E, 0x34CF ); //	P_G2_P3Q0
	MT9M114_write_cmos_sensor(0x3720, 0xF72E ); //	P_G2_P3Q1
	MT9M114_write_cmos_sensor(0x3722, 0xD731 ); //	P_G2_P3Q2
	MT9M114_write_cmos_sensor(0x3724, 0x5510 ); //	P_G2_P3Q3
	MT9M114_write_cmos_sensor(0x3726, 0x5593 ); //	P_G2_P3Q4
	MT9M114_write_cmos_sensor(0x3740, 0x16ED ); //	P_G1_P4Q0
	MT9M114_write_cmos_sensor(0x3742, 0x30D1 ); //	P_G1_P4Q1
	MT9M114_write_cmos_sensor(0x3744, 0x8A55 ); //	P_G1_P4Q2
	MT9M114_write_cmos_sensor(0x3746, 0xD372 ); //	P_G1_P4Q3
	MT9M114_write_cmos_sensor(0x3748, 0x0777 ); //	P_G1_P4Q4
	MT9M114_write_cmos_sensor(0x374A, 0x456E ); //	P_R_P4Q0
	MT9M114_write_cmos_sensor(0x374C, 0x19F1 ); //	P_R_P4Q1
	MT9M114_write_cmos_sensor(0x374E, 0x8CD5 ); //	P_R_P4Q2
	MT9M114_write_cmos_sensor(0x3750, 0xC471 ); //	P_R_P4Q3
	MT9M114_write_cmos_sensor(0x3752, 0x0D97 ); //	P_R_P4Q4
	MT9M114_write_cmos_sensor(0x3754, 0x5C8D ); //	P_B_P4Q0
	MT9M114_write_cmos_sensor(0x3756, 0x22B1 ); //	P_B_P4Q1
	MT9M114_write_cmos_sensor(0x3758, 0xE274 ); //	P_B_P4Q2
	MT9M114_write_cmos_sensor(0x375A, 0xF2B1 ); //	P_B_P4Q3
	MT9M114_write_cmos_sensor(0x375C, 0x6896 ); //	P_B_P4Q4
	MT9M114_write_cmos_sensor(0x375E, 0xCF8D ); //	P_G2_P4Q0
	MT9M114_write_cmos_sensor(0x3760, 0x3A51 ); //	P_G2_P4Q1
	MT9M114_write_cmos_sensor(0x3762, 0xF854 ); //	P_G2_P4Q2
	MT9M114_write_cmos_sensor(0x3764, 0xEB92 ); //	P_G2_P4Q3
	MT9M114_write_cmos_sensor(0x3766, 0x78B6 ); //	P_G2_P4Q4
	MT9M114_write_cmos_sensor(0x3784, 0x02A0 ); //	CENTER_COLUMN
	MT9M114_write_cmos_sensor(0x3782, 0x01CC ); //	CENTER_ROW
	MT9M114_write_cmos_sensor(0x37C0, 0x04CA ); //	P_GR_Q5
	MT9M114_write_cmos_sensor(0x37C2, 0x0DCA ); //	P_RD_Q5
	MT9M114_write_cmos_sensor(0x37C4, 0x0C69 ); //	P_BL_Q5
	MT9M114_write_cmos_sensor(0x37C6, 0x280A ); //	P_GB_Q5
	...
	MT9M114_write_cmos_sensor(0xC962, 0x810A ); //	CAM_PGA_L_CONFIG_GREEN_RED_Q14
	MT9M114_write_cmos_sensor(0xC964, 0x811C ); //	CAM_PGA_L_CONFIG_RED_Q14
	MT9M114_write_cmos_sensor(0xC966, 0x8150 ); //	CAM_PGA_L_CONFIG_GREEN_BLUE_Q14
	MT9M114_write_cmos_sensor(0xC968, 0x808C ); //	CAM_PGA_L_CONFIG_BLUE_Q14
	MT9M114_write_cmos_sensor(0xC96A, 0x0FA0 ); //	CAM_PGA_M_CONFIG_COLOUR_TEMP
	MT9M114_write_cmos_sensor(0xC96C, 0x810A ); //	CAM_PGA_M_CONFIG_GREEN_RED_Q14
	MT9M114_write_cmos_sensor(0xC96E, 0x811C ); //	CAM_PGA_M_CONFIG_RED_Q14
	MT9M114_write_cmos_sensor(0xC970, 0x8150 ); //	CAM_PGA_M_CONFIG_GREEN_BLUE_Q14
	MT9M114_write_cmos_sensor(0xC972, 0x808C ); //	CAM_PGA_M_CONFIG_BLUE_Q14
	MT9M114_write_cmos_sensor(0xC974, 0x1964 ); //	CAM_PGA_R_CONFIG_COLOUR_TEMP
	MT9M114_write_cmos_sensor(0xC976, 0x810A ); //	CAM_PGA_R_CONFIG_GREEN_RED_Q14
	MT9M114_write_cmos_sensor(0xC978, 0x811C ); //	CAM_PGA_R_CONFIG_RED_Q14
	MT9M114_write_cmos_sensor(0xC97A, 0x8150 ); //	CAM_PGA_R_CONFIG_GREEN_BLUE_Q14
	MT9M114_write_cmos_sensor(0xC97C, 0x808C ); //	CAM_PGA_R_CONFIG_BLUE_Q14
    ...
    MT9M114_write_cmos_sensor(0xC984, 0x8040);// CAM_PORT_OUTPUT_CONTROL
    MT9M114_write_cmos_sensor(0x001E, 0x0777);// PAD_SLEW
    MT9M114_write_cmos_sensor(0xC984, 0x8041);// CAM_PORT_OUTPUT_CONTROL
    MT9M114_write_cmos_sensor(0xC988, 0x0F00);// CAM_PORT_MIPI_TIMING_T_HS_ZERO
    MT9M114_write_cmos_sensor(0xC98A, 0x0B07);// CAM_PORT_MIPI_TIMING_T_HS_EXIT_HS_TRAIL
    MT9M114_write_cmos_sensor(0xC98C, 0x0D01);// CAM_PORT_MIPI_TIMING_T_CLK_POST_CLK_PRE
    MT9M114_write_cmos_sensor(0xC98E, 0x071D);// CAM_PORT_MIPI_TIMING_T_CLK_TRAIL_CLK_ZERO
    MT9M114_write_cmos_sensor(0xC990, 0x0006); // CAM_PORT_MIPI_TIMING_T_LPX 
    MT9M114_write_cmos_sensor(0xC992, 0x0A0C);// CAM_PORT_MIPI_TIMING_INIT_TIMING
    MT9M114_write_cmos_sensor(0x3C5A, 0x0009);// MIPI_DELAY_TRIM
    MT9M114_write_cmos_sensor_8(0xDC00, 0x40);// SYSMGR_NEXT_STATE
    MT9M114_write_cmos_sensor(0x0080, 0x8002);// COMMAND_REGISTER
//DELAY=500
...
//DELAY=500
	mDELAY(100);
    MT9M114_write_cmos_sensor_8(0xDC00, 0x34);// SYSMGR_NEXT_STATE
    MT9M114_write_cmos_sensor(0x0080, 0x8002);// // COMMAND_REGISTER
	//mDELAY(100);//20130308
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    switch(ScenarioId)
    {
        case MSDK_SCENARIO_ID_CAMERA_ZSD:
            pSensorInfo->SensorPreviewResolutionX = MT9M114_IMAGE_SENSOR_FULL_WIDTH - 4; /* not use */
            pSensorInfo->SensorPreviewResolutionY = MT9M114_IMAGE_SENSOR_FULL_HEIGHT - 3; /* not use */
	...
	pSensorInfo->SensorFullResolutionX=MT9M114_IMAGE_SENSOR_FULL_WIDTH - 4;
	pSensorInfo->SensorFullResolutionY=MT9M114_IMAGE_SENSOR_FULL_HEIGHT - 3;
