...
public final class GeminiSmsManager {
    ...
    public SmsBroadcastConfigInfo[] getCellBroadcastSmsConfig(int slotId) {
        Log.d(TAG, "getCellBroadcastSmsConfig");
        ...
        try {
            ...
            Log.d(TAG, "getCellBroadcastSmsConfig, RemoteException!");
        }

        if (configs != null)
        {
            Log.d(TAG, "config length = "+configs.length);
            int i=0;
            if (configs.length != 0) {
    ...
    public boolean setCellBroadcastSmsConfig(SmsBroadcastConfigInfo[] channels,
        ...
        Log.d(TAG, "setCellBroadcastSmsConfig");
        Log.d(TAG, "slotId="+slotId);
        Log.d(TAG, "channel size="+channels.length);
        Log.d(TAG, "language size="+languages.length);
        boolean result = false;
        String isms = getSmsServiceName(slotId);
        ...
        try {
            ...
            Log.d(TAG, "setCellBroadcastSmsConfig, RemoteException!");
        }
    ...
    public boolean queryCellBroadcastSmsActivation(int slotId) {
        Log.d(TAG, "queryCellBroadcastSmsActivation");
        Log.d(TAG, "slotId="+slotId);
        boolean result = false;
        String isms = getSmsServiceName(slotId);
        ...
        try {
            ...
            Log.d(TAG, "queryCellBroadcastSmsActivation, RemoteException!");
        }
