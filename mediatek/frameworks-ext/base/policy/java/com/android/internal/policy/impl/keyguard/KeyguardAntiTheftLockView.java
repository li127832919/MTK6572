...
public class KeyguardAntiTheftLockView extends KeyguardAbsKeyInputView
    ...
    protected void verifyPasswordAndUnlock() {
        ...
        if(AntiTheftManager.getInstance(null,null,null).checkPassword(entry)) {
            ...
            // Because other security views except AntiTheft mode can show other info on status bar, 
            // we need to call KeyguardViewMediator.adjustStatusBarLocked() to reset/adjust status bar info.
    ...
    protected void onFinishInflate() {
		...
		mBouncerFrameView = findViewById(com.mediatek.internal.R.id.keyguard_bouncer_frame);
		mKey0 = findViewById(com.mediatek.internal.R.id.key0);
		mKey1 = findViewById(com.mediatek.internal.R.id.key1);
		mKey2 = findViewById(com.mediatek.internal.R.id.key2);
		mKey3 = findViewById(com.mediatek.internal.R.id.key3);
		mKey4 = findViewById(com.mediatek.internal.R.id.key4);
		mKey5 = findViewById(com.mediatek.internal.R.id.key5);
		mKey6 = findViewById(com.mediatek.internal.R.id.key6);
		mKey7 = findViewById(com.mediatek.internal.R.id.key7);
		mKey8 = findViewById(com.mediatek.internal.R.id.key8);
		mKey9 = findViewById(com.mediatek.internal.R.id.key9);
		ok = findViewById(R.id.key_enter);
		pinDelete = findViewById(R.id.delete_button);
		mAntiTheftPinEntry = (TextView)findViewById(com.mediatek.internal.R.id.antiTheftPinEntry) ;
    ...
    public int getWrongPasswordStringId() {
        return com.android.internal.R.string.kg_wrong_pin;
    }
    ...
    public void onPause() {
       ...
       AntiTheftManager.setCurrentAntiTheftLockView(false) ;
    ...
    public void onResume(int reason) {
        ...
        AntiTheftManager.setCurrentAntiTheftLockView(true) ;
        AntiTheftManager.getInstance(null,null,null).adjustStatusBarLocked() ;
        
        mSecurityMessageDisplay.setMessage(com.android.internal.R.string.kg_pin_instructions, true);
    ...
    public void showBouncer(int duration) {
        // If we only show bouncer without showing the hit string,
        // user will be easily confused.
        // So we force anti-theft always shows complete security screen.
