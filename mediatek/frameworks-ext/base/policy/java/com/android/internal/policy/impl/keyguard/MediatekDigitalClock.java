 ...
 * Displays the time
 */
public class MediatekDigitalClock extends RelativeLayout {
    ...
    private static class TimeChangedReceiver extends BroadcastReceiver {
        private WeakReference<MediatekDigitalClock> mClock;
        private Context mContext;

        public TimeChangedReceiver(MediatekDigitalClock clock) {
            mClock = new WeakReference<MediatekDigitalClock>(clock);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final MediatekDigitalClock clock = mClock.get();
            if (clock != null) {
    ...
    private static class FormatChangeObserver extends ContentObserver {
        private WeakReference<MediatekDigitalClock> mClock;
        private Context mContext;
        public FormatChangeObserver(MediatekDigitalClock clock) {
            super(new Handler());
            mClock = new WeakReference<MediatekDigitalClock>(clock);
            mContext = clock.getContext();
        }
        ...
        public void onChange(boolean selfChange) {
            MediatekDigitalClock digitalClock = mClock.get();
    ...
    protected void onFinishInflate() {
        ...
        mTimeView = (TextView) findViewById(com.mediatek.internal.R.id.clock_text);
	if (mTimeView == null) {
        }
