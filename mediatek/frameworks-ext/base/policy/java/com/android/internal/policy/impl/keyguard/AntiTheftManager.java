...
public class AntiTheftManager {
	...
	public static int getAntiTheftViewId() {
		return com.mediatek.internal.R.id.keyguard_anti_theft_lock_view;
	}

	public static int getAntiTheftLayoutId() {
		return com.mediatek.internal.R.layout.keyguard_anti_theft_lock_view;
	}
	...
	public static int getPrompt() {
		...
		if(mode == AntiTheftMode.DmLock) {
				return com.mediatek.internal.R.string.dm_prompt;
		}
		else {
				return com.mediatek.internal.R.string.ppl_prompt;
		}			
	}   
    ...
    private static boolean doPplCheckPassword(String pw) {
        boolean unlockSuccess = false ;
        Log.d(TAG, "doPplCheckPassword pw = " + pw) ;
    ...
    private static boolean isCurrentAntiTheftView = false ;
    public static boolean isCurrentAntiTheftLockView() {
        return isCurrentAntiTheftView ;
    }
    public static void setCurrentAntiTheftLockView(boolean isAntiTheftView) {
        isCurrentAntiTheftView = isAntiTheftView ;    
    }   
}
