...
public class BluetoothTetheringDataTracker implements NetworkStateTracker {
    ...
    //mtk80684 add 2012.12.06
    public static final String ACTION_START_REVERSE_TETHER = "android.bluetooth.BluetoothTetheringDataTracker.ACTION_START_REVERSE_TETHER";
    public static final String ACTION_STOP_REVERSE_TETHER = "android.bluetooth.BluetoothTetheringDataTracker.ACTION_STOP_REVERSE_TETHER";
    public static final String EXTRA_INTERFACE = "android.bluetooth.BluetoothTetheringDataTracker.EXTRA_INTERFACE";
    //mtk80684 add end
    ...
    private BluetoothTetheringDataTracker() {
        Log.d(TAG, "BluetoothTetheringDataTracker initiate ");
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
		    String iface = intent.getStringExtra(BluetoothTetheringDataTracker.EXTRA_INTERFACE);
			Log.d(TAG, "iface = "+iface);
	        if (ACTION_START_REVERSE_TETHER.equals(intent.getAction())) {
	            BluetoothDevice device = intent.getParcelableExtra(BluetoothDevice.EXTRA_DEVICE);
		    startReverseTether(iface);
	        }else if(ACTION_STOP_REVERSE_TETHER.equals(intent.getAction())) {
		    stopReverseTether();
	        }
        }
    };
	...
	IntentFilter filter = new IntentFilter();
        filter.addAction(ACTION_START_REVERSE_TETHER);
        filter.addAction(ACTION_STOP_REVERSE_TETHER);
