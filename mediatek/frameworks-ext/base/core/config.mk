...
# MEDIATEK FOR SUCH MEDIATEK SOFTWARE AT ISSUE.HI
#
...
else # ANDROID_BT_JB_MR1 is not defined or = no

# We choose architecture before MR1
# Filter out MR1 original AIDL files <duplicate with MR0>
...
#Do not filter for MR0 DroidDoc
#LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/IBluetoothGattServerCallback.aidl, $(LOCAL_SRC_FILES))
#LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/IBluetoothGattCallback.aidl, $(LOCAL_SRC_FILES))
#LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/IBluetoothGatt.aidl, $(LOCAL_SRC_FILES))
#LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/IBluetoothManager.aidl, $(LOCAL_SRC_FILES))
#LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/IBluetoothManagerCallback.aidl, $(LOCAL_SRC_FILES))

#Replaced with AIDL files in MR0 (may be customized by MTK)
LOCAL_SRC_FILES += \
...
LOCAL_SRC_FILES := $(filter-out ../../mediatek/frameworks-ext/base/core/java/android/bluetooth/BluetoothCmnAdapter.java, $(LOCAL_SRC_FILES))

LOCAL_SRC_FILES := $(filter-out ../../mediatek/frameworks-ext/base/core/java/android/bluetooth/4.1/BluetoothDunEx.java, $(LOCAL_SRC_FILES))
else

#Use architecture "before MR1". Filter out MR1 original SDK files
...
LOCAL_SRC_FILES := $(filter-out ../../mediatek/frameworks-ext/base/core/java/android/bluetooth/4.2/BluetoothDunEx.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothCmnAdapter.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothManager.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothGattService.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothGattServer.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothGattServerCallback.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothGatt.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothGattDescriptor.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothGattCharacteristic.java, $(LOCAL_SRC_FILES))
LOCAL_SRC_FILES := $(filter-out core/java/android/bluetooth/BluetoothGattCallback.java, $(LOCAL_SRC_FILES))
