...
ifeq (yes, $(strip $(MTK_TER_SERVICE)))
  ifneq (yes, $(strip $(MTK_REGIONALPHONE_SUPPORT)))
    $(call dep-err-ona-or-offb,MTK_REGIONALPHONE_SUPPORT,MTK_TER_SERVICE)
  endif
endif
##########################################################################
...
ifeq (yes, $(strip $(MTK_ASR_SUPPORT)))
  ...
  ifneq (yes, $(strip $(MTK_AUDIO_HD_REC_SUPPORT)))
   $(call dep-err-ona-or-offb,MTK_AUDIO_HD_REC_SUPPORT,MTK_ASR_SUPPORT)
  endif
  ifneq (yes, $(strip $(MTK_HANDSFREE_DMNR_SUPPORT)))
   $(call dep-err-ona-or-offb,MTK_HANDSFREE_DMNR_SUPPORT,MTK_ASR_SUPPORT)
  endif
endif
