...
newall: cleanall pregen remakeall bootimage
...
ANDROID_NATIVE_TARGETS := \
         ...
         snod systemimage recoveryimage secroimage target-files-package \
...
bootimage:
	...
	$(hide) $(MKBOOTIMG) --kernel $(PRODUCT_OUT)/kernel_$(PROJECT).bin --ramdisk $(PRODUCT_OUT)/ramdisk.img --output $(PRODUCT_OUT)/boot.img
	$(hide) $(SHOWRSLT) 0 /dev/null $(ACTION)
