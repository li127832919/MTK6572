...
LOCAL_C_INCLUDES:= $(LOCAL_PATH)/mnl6582/inc \
                   ...
                   $(MTK_PATH_CUSTOM)/cgen/inc  
LOCAL_SHARED_LIBRARIES += libcutils libc libm libnvram
LOCAL_STATIC_LIBRARIES += libmnl_6582 libcutils libc libm libsupl libagent_6582 libhotstill
LOCAL_MODULE_TAGS := optional
...
LOCAL_C_INCLUDES:= $(LOCAL_PATH)/mnl6630/inc \
                   ...
                   $(MTK_PATH_CUSTOM)/cgen/inc  
LOCAL_SHARED_LIBRARIES += libcutils libc libm libnvram
LOCAL_STATIC_LIBRARIES += libmnl_6630 libcutils libc libm libsupl libagent_6630 libhotstill
LOCAL_MODULE_TAGS := optional
...
LOCAL_C_INCLUDES:= $(LOCAL_PATH)/mnl6592/inc \
                   ...
                   $(MTK_PATH_CUSTOM)/cgen/inc  
LOCAL_SHARED_LIBRARIES += libcutils libc libm libnvram
LOCAL_STATIC_LIBRARIES += libmnl_6592 libcutils libc libm libsupl libagent_6592 libhotstill
LOCAL_MODULE_TAGS := optional
...
LOCAL_C_INCLUDES:= $(LOCAL_PATH)/mnl6571/inc \
                   ...
                   $(MTK_PATH_CUSTOM)/cgen/inc  
LOCAL_SHARED_LIBRARIES += libcutils libc libm libnvram
LOCAL_STATIC_LIBRARIES += libmnl_6571 libcutils libc libm libsupl libagent_6571 libhotstill
LOCAL_MODULE_TAGS := optional
